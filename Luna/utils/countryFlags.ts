 ...
 * @returns Emoji de la bandera o emoji por defecto
 */
 ...
 * @param address Dirección en formato "City, Country" o similar
 * @returns Nombre del país
 */
export function extractCountryFromAddress(address?: string): string | undefined {
 ...
 * @param address Dirección completa del usuario
 * @returns Emoji de la bandera del país
 */
export function getFlagFromAddress(address?: string): string {
